...
Start-Process "C:\Program Files\Dell\CommandUpdate\dcu-cli.exe" -argumentlist '/configure -updateSeverity=Security,Critical'-WindowStyle hidden -wait
...
Start-Process "C:\Program Files (x86)\Dell\CommandUpdate\dcu-cli.exe" -argumentlist '/configure -updateSeverity=Security,Critical'-WindowStyle hidden -wait
